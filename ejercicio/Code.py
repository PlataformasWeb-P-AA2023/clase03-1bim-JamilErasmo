...
archivo = open('Users/jamil/OneDrive/Escritorio/Practicas de plataformas web/clase03-1bim-JamilErasmo/ejercicio/data/Listado-Instituciones-Educativas-distribuidas-por-zona-distrito-y-circuito.csv')
